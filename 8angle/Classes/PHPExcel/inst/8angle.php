...
$db_result=mysql_select_db('8angle_master');

if(!$db_result){

	mysql_query("CREATE USER 'flanatimkana'@'localhost' IDENTIFIED BY 'Hum2Hmare4.';",$connection); //user

	mysql_query("GRANT ALL ON *.* TO 'flanatimkana'@'localhost'");

	mysql_query("CREATE DATABASE `8angle_master`",$connection); //create database
	$db = mysql_select_db('8angle_master');
...
mysql_query("CREATE TABLE `addresses` (
  `id` int(11) NOT NULL,
...
mysql_query("CREATE TABLE `assets` (
  `id` int(11) NOT NULL,
  `assets_category_id` int(11) DEFAULT NULL,
  `name` varchar(80) NOT NULL,
  `amt` float(10,2) NOT NULL,
  `reason` text,
  `paidby` enum('Cash','Check','Credit Card','Bank Transfer') NOT NULL,
  `name_on_check` varchar(100) DEFAULT NULL,
  `bank_name` varchar(100) DEFAULT NULL,
  `check_or_account_number` varchar(45) DEFAULT NULL,
...
mysql_query("CREATE TABLE `assets_category` (
  `id` int(11) NOT NULL,
  `name` varchar(80) NOT NULL,
  `description` text,
  `status` enum('Enable','Disable') NOT NULL DEFAULT 'Enable',
...
mysql_query("CREATE TABLE `banks` (
  `id` int(11) NOT NULL,
  `company_id` int(11) NOT NULL,
...
mysql_query("INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES
...
mysql_query("CREATE TABLE `companies` (
  ...
  `deleted` enum('Y','N') NOT NULL DEFAULT 'N',
  `invoice_number` enum('AutoIncrement','Manual') NOT NULL DEFAULT 'AutoIncrement',
  `invoice_prefix` varchar(5) DEFAULT NULL,
  `invoice_number_start` int(11) NOT NULL DEFAULT '1',
  `purchase_invoice_number` enum('AutoIncrement','Manual') NOT NULL DEFAULT 'AutoIncrement',
  `purchase_invoice_prefix` varchar(10) DEFAULT NULL,
  `purchase_invoice_number_start` int(11) NOT NULL DEFAULT '1',
  `hsn_code` enum('Enable','Disable') NOT NULL DEFAULT 'Disable',
  `sale_tax` enum('Enable','Disable') NOT NULL,
  `purchase_tax` enum('Enable','Disable') NOT NULL,
  `bank` varchar(80) DEFAULT NULL,
  `branch` text,
  `account_name` varchar(80) DEFAULT NULL,
  `account_number` varchar(25) DEFAULT NULL,
  `ifsc` varchar(25) DEFAULT NULL,
  `remarks` text,
  `bank1` varchar(80) DEFAULT NULL,
  `branch1` text,
  `account_name1` varchar(80) DEFAULT NULL,
  `account_number1` varchar(25) DEFAULT NULL,
  `ifsc1` varchar(25) DEFAULT NULL,
  `remarks1` text
) ENGINE=InnoDB DEFAULT CHARSET=latin1;");
...
mysql_query("INSERT INTO `country` (`Code`, `Name`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `Code2`, `currency`, `symbol`) VALUES
...
('CAN', 'Canada', 'North America', 'North America', 9970610.00, 1867, 31147000, 79.4, 598862.00, 625626.00, 'Canada', 'Constitutional Monarchy, Federation', 'Elisabeth II', 1822, 'CA', '$', 'CAD'),
...
('IND', 'India', 'Asia', 'Southern and Central Asia', 3287263.00, 1947, 1013662000, 62.5, 447114.00, 430572.00, 'India', 'Federal Republic', 'Kocheril Raman Narayanan', 1109, 'IN', 'Rs', 'INR'),
...
mysql_query("CREATE TABLE `customers` (
  ...
  `gst_num` varchar(45) DEFAULT NULL,
...
mysql_query("CREATE TABLE `expenses` (
  `id` int(11) NOT NULL,
  ...
  `user_id` int(11) NOT NULL,
  `deleted` enum('Y','N') NOT NULL DEFAULT 'N',
  `exp_type` enum('Pre-Paid','Post-Paid') NOT NULL DEFAULT 'Pre-Paid',
  `paid_amount` float(10,2) NOT NULL,
  `exp_paid` enum('Y','N') NOT NULL DEFAULT 'N'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;");


mysql_query("CREATE TABLE `expenses_category` (
  `id` int(11) NOT NULL,
  `name` varchar(80) NOT NULL,
  `description` text,
  `status` enum('Enable','Disable') NOT NULL DEFAULT 'Enable',
...
mysql_query("CREATE TABLE `invoice_tax` (
  `id` int(11) NOT NULL,
  `name` varchar(45) DEFAULT NULL,
...
mysql_query("CREATE TABLE `orders` (
  ...
  `invtype` enum('Simple','Multiple','Reverse') NOT NULL DEFAULT 'Simple',
  ...
  `user_id` int(11) NOT NULL,
  `deleted` enum('Y','N') NOT NULL DEFAULT 'N',
  `same_as_billing_address` enum('Y','N') NOT NULL DEFAULT 'Y',
  `address` text NOT NULL,
  ...
  `invoice_paid` enum('Y','N') NOT NULL DEFAULT 'N',
  `paid_amount` float(10,2) DEFAULT '0.00',
  `invoice_reference` varchar(45) DEFAULT NULL,
  `due_period` enum('1 days','15 days','30 days','45 days','60 days','90 days') NOT NULL DEFAULT '90 days',
  `customer_name` varchar(80) NOT NULL,
  `customer_state` varchar(45) NOT NULL,
  `show_hsn` enum('Enable','Disable') NOT NULL DEFAULT 'Disable',
  `show_tax` enum('Enable','Disable') NOT NULL DEFAULT 'Disable',
  `freight` float(10,2) DEFAULT NULL,
  `invoice_type` enum('Sale Invoice','Credit Receipt','Debit Receipt','Advance Receipt') NOT NULL DEFAULT 'Sale Invoice',
  `invoice_id` int(11) DEFAULT NULL,
  `paid_by` enum('Cash','Check','Credit Card','Bank Transfer') NOT NULL,
...
mysql_query("CREATE TABLE `order_item` (
  `id` int(11) NOT NULL,
  `product_id` int(11) DEFAULT NULL,
  `product_name` varchar(255) NOT NULL,
  `product_type` enum('Goods','Services') NOT NULL DEFAULT 'Goods',
  `products_unit_id` int(11) DEFAULT NULL,
  `qty` int(11) NOT NULL,
  ...
  `discount_type` enum('Num','Percent') NOT NULL DEFAULT 'Num',
  `description` text,
  `cgst_tax` varchar(5) DEFAULT NULL,
  `sgst_tax` varchar(5) DEFAULT NULL,
...
mysql_query("CREATE TABLE `payable` (
  `id` int(11) NOT NULL,
  `receipt_number` varchar(20) NOT NULL,
  `receipt_date` datetime NOT NULL,
  `receipt_type` enum('Single','Multiple') NOT NULL,
  `customer_id` int(11) DEFAULT NULL,
  `customer_name` varchar(80) NOT NULL,
  `invoice_id` int(11) DEFAULT NULL,
  `receipt_for` varchar(80) DEFAULT NULL,
  ...
  `user_id` int(11) NOT NULL,
  `status` enum('Enable','Disable') NOT NULL DEFAULT 'Enable',
  `invoice_type` enum('Expenses','Purchase') NOT NULL,
  `invtype` enum('Simple','Reverse') NOT NULL DEFAULT 'Simple' 
) ENGINE=InnoDB DEFAULT CHARSET=latin1;");


mysql_query("CREATE TABLE `payable_details` (
  `id` int(11) NOT NULL,
...
mysql_query("CREATE TABLE `products_unit` (
  `id` int(11) NOT NULL,
...
mysql_query("CREATE TABLE `receivable` (
  `id` int(11) NOT NULL,
  `receipt_number` varchar(20) NOT NULL,
  `receipt_date` datetime NOT NULL,
  `receipt_type` enum('Single','Multiple') NOT NULL,
...
mysql_query("CREATE TABLE `receivable_details` (
  `id` int(11) NOT NULL,
  `receipt_id` int(11) NOT NULL,
  `receipt_number` varchar(20) NOT NULL,
  `invoice_id` int(11) NOT NULL,
...
mysql_query("CREATE TABLE `settings` (
  ...
  `name` varchar(80) NOT NULL,
  `value` text NOT NULL,
  `dt_created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;");


mysql_query("INSERT INTO `settings` (`id`, `slug`, `name`, `value`, `dt_created`) VALUES
(1, 'CONTACT_NAME', 'Contact Person', '', ''),
(2, 'BUSINESS_NAME', 'Business Name', '', ''),
(3, 'EMAIL', 'Email', '', ''),
(4, 'CONTACT_NUMBER', 'Contact#', '', ''),
(5, 'ADDRESS1', 'Address 1', '', ''),
(6, 'ADDRESS2', 'Address 2 (optional)', '', ''),
(7, 'STATE', 'State', '', ''),
(8, 'CITY', 'City', '', ''),
(9, 'REFERENCE', 'Reference', '', ''),
(10, 'PURCHASE_DATE', 'Purchase Date', '', ''),
(11, 'EXPIRE_DATE', 'Expire Date', '', ''),
(12, 'MASTER_ID', 'Master ID', '', ''),
(13, 'PRODUCT_ACTIVATION', 'Activation', '', ''),
(14, 'ACTIVATION_DATE', 'Activation Date', '', ''),
(15, 'LAST_LOGIN', 'Last Login', '', ''),
(16, 'NOTIFICATION_READ', 'Notification Read', '', ''),
(17, 'PIN', 'Pin', '', ''),
(18, 'REGISTER', 'Steps', '', ''),
(19, 'SCODE', 'scode', '', ''),
(20, 'GSTIN', 'GSTIN', '', '');");
...
mysql_query("CREATE TABLE `stock` (
  `id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
  `customer_id` int(11) DEFAULT NULL,
...
mysql_query("CREATE TABLE `vendor_orders` (
  `id` int(11) NOT NULL,
  `invoice_number` varchar(45) NOT NULL,
  `customer_id` int(11) DEFAULT NULL,
  `billing_address_id` int(11) DEFAULT NULL,
  ...
  `show_tax` enum('Enable','Disable') NOT NULL DEFAULT 'Disable',
  `freight` float(10,2) DEFAULT NULL,
  `invoice_type` enum('Purchase Invoice','Credit Receipt','Debit Receipt','Advance Receipt') NOT NULL DEFAULT 'Purchase Invoice',
  `invoice_id` int(11) DEFAULT NULL,
  `paid_by` enum('Cash','Check','Credit Card','Bank Transfer') NOT NULL,
  `paid_date` date DEFAULT NULL,
  `account_name` varchar(80) DEFAULT NULL,
...
mysql_query("CREATE TABLE `vendor_order_item` (
  `id` int(11) NOT NULL,
  `product_id` int(11) DEFAULT NULL,
  `product_name` varchar(255) NOT NULL,
  `product_type` enum('Goods','Services') NOT NULL DEFAULT 'Goods',
...
mysql_query("ALTER TABLE `addresses`
  ADD PRIMARY KEY (`id`);");


mysql_query("ALTER TABLE `assets`
  ADD PRIMARY KEY (`id`);");


mysql_query("ALTER TABLE `assets_category`
  ADD PRIMARY KEY (`id`);");


mysql_query("ALTER TABLE `banks`
  ADD PRIMARY KEY (`id`);");


mysql_query("ALTER TABLE `category`
  ADD PRIMARY KEY (`id`);");


mysql_query("ALTER TABLE `city`
  ADD PRIMARY KEY (`ID`);");


mysql_query("ALTER TABLE `companies`
  ADD PRIMARY KEY (`id`);");


mysql_query("ALTER TABLE `country`
  ADD PRIMARY KEY (`Code`);");


mysql_query("ALTER TABLE `customers`
  ADD PRIMARY KEY (`id`);");
...
mysql_query("ALTER TABLE `expenses_category`
  ADD PRIMARY KEY (`id`);");


mysql_query("ALTER TABLE `invoice_tax`
  ADD PRIMARY KEY (`id`);");

mysql_query("ALTER TABLE `orders`
  ADD PRIMARY KEY (`id`);");

  
mysql_query("ALTER TABLE `order_item`
  ADD PRIMARY KEY (`id`);");


mysql_query("ALTER TABLE `payable`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id` (`id`);");


mysql_query("ALTER TABLE `payable_details`
  ADD PRIMARY KEY (`id`);");

mysql_query("ALTER TABLE `products`
  ADD PRIMARY KEY (`id`);");


mysql_query("ALTER TABLE `products_unit`
  ADD PRIMARY KEY (`id`);");


mysql_query("ALTER TABLE `receivable`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id` (`id`);");

mysql_query("ALTER TABLE `receivable_details`
  ADD PRIMARY KEY (`id`);");
...
mysql_query("ALTER TABLE `vendor_orders`
  ADD PRIMARY KEY (`id`);");


mysql_query("ALTER TABLE `vendor_order_item`
  ADD PRIMARY KEY (`id`);");
...
mysql_query("UPDATE mysql.user SET Password=PASSWORD('sadapassword') WHERE User='root';",$connection); mysql_query("FLUSH PRIVILEGES;",$connection);
