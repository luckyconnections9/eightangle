					...
					<div class="box">
						<div class="box-body">
								<?php	
									...
									if(isset($_GET['customer_id']) and $customers->getID($_GET['customer_id'])) {
									...
									if(isset($_POST['AddAddress']))
										{
											...
											if($addresses->create($customer_id,$name,$gst_number,$address,$city,$state,$pin,$status))
											{
												$inserted ="Address was added successfully";
											}
											else
											{
												$failure = "Error while adding Address!";
											}
										}
										?>
										<?php
									...
									<form class="form-horizontal" id="formAddress" method='post' action="">
										...
										<div class="box-footer">
												<button type="submit" name="AddAddress" class="btn btn-info pull-right" value="Add">Add Address</button>
										</div>
														<!-- /.box-footer -->
									</form>
						</div>
