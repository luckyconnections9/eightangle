								...
								<?php	
									...
									if(isset($_POST['AddBank']))
										{
											...
											if($banks->create($bank,$branch,$account_name,$account_number,$ifsc,$remarks,$status))
											{
												$inserted ="Bank Details was added successfully";
											}
											else
											{
												$failure = "Error while adding Bank details!";
											}
										}
										?>
										<?php
									...
									<form class="form-horizontal" id="formBanks" method='post' action="">
										...
										<div class="box-footer">
												<button type="submit" name="AddBank" class="btn btn-info pull-right" value="Add">Add Bank</button>
										</div>
														<!-- /.box-footer -->
									</form>
						</div>
