...
$meta_title = "Add Expenses - 8angle | POS  ";
require('header.php');
require('left.php');
			...
			<div class="box-body">
					<?php	
						...
						if(isset($_POST['AddExpense']))
							{
								...
								if($expenses->create($name,$amt,$reason,$paidby,$pay_date,$description,$status,$expenses_category_id,$name_on_check,$bank_name,$check_or_account_number,$exp_type))
								{
									$inserted ="Expense was added successfully";
								}
								else
								{
									$failure = "Error while adding Expense!";
								}
							}
							?>
							<?php
                        ...
                        <label class="col-sm-3 control-label">Select Expense Type</label>
							...
							<div class="form-group">
						<label for="Expenses category" class="col-sm-3 control-label">Expense Category</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="box-footer">
								<a href="<?php echo BASE_URL;?>expenses.php" class="btn btn-default">Cancel</a>
									<button type="submit" name="AddExpense" class="btn btn-info pull-right" value="Add">Add Expense</button>
							</div>
											<!-- /.box-footer -->
						</form>
			</div>
