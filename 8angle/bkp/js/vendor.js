...
$(document).ready(function() {
  ...
  $('input').click(function(){
	...
	var Show_Purchasetax = $('#Show_Purchasetax').val(); 
	if(Show_Purchasetax == "Enable") { Show_Purchase = "visible"; } else { Show_Purchase = "none";}
  ...
  $("#addRow").click(function(){
    ...
    $(".item-row:last").after( '<tr  id="inv'+ ( h )+'"  class="item-row"><td><a class="delete" title="remove Item"><i class="glyphicon glyphicon-remove-circle"></i></a></td><input  name="inv_product_id[]" readonly="readonly" type="hidden"  value="" id="inv_product_id"  tabindex="1" /><td><input name="inv_product_name[]" class="form-control"  value="" id="inv_product_name" autocomplete="off" onkeyup="load_search(this.value,'+d+')" tabindex="1" /><br/><span id="showdata'+d+'" class="showdata"></span></td><td><select  name="inv_product_type[]" id="inv_product_type"  class="inv_product_type  form-control" ><option value="Goods">Goods</option><option value="Services">Services</option></select></td><td style="display:'+Show_HSN+'"><span class="HSN_code_show"></span></td><td><select  name="inv_product_unit[]" id="inv_product_unit"  class="inv_product_unit  form-control" ></select></td><td><input type="text" value="1"  class="qty form-control" name="inv_product_qty[]"  id="inv_product_qty" /></td><td><input type="text" value="0.00" class="cost form-control" name="inv_product_cost[]"  id="inv_product_cost" /></td><td style="display:'+Show_Purchase+'"><select name="tax_type[]" onChange="load_taxes(this.value,'+d+')" id="tax_type"  class="tax_type form-control" ></select><input  name="tax_amount[]" class="tax_amount" readonly="readonly" type="hidden"  value="" id="tax_amount"  tabindex="1" /><span class="row_number">'+d+'</span></td><td><input type="text" value="0.00"  class="discount form-control" name="inv_product_discount[]"  id="inv_product_discount" /> <span class="discount_amount"></span></td><td><span class="total_amount_te">0.00</span></td><td style="display:'+Show_Purchase+'"><span class="total_tax">0.00</span><span class="tax_hidden"><input type="hidden" name="cgst_tax_percent[]" id="cgst_tax_percent" class="cgst_tax_percent" value="0"><span id="cgst_amt" class="cgst_amt"></span> [ <input type="hidden" name="sgst_tax_percent[]" id="sgst_tax_percent" class="sgst_tax_percent" value="0"><span id="sgst_amt" class="sgst_amt"></span>]</span></td><td><span class="total_discount">0.00</span></td><td><span class="grand_total">0.00</span></td></tr>');
  ...
  $("#items").on('click','.delete',function(){ 
	...
	{ 
        $.post('global_vendor_search.php', {'search_term':val}, function(data){
			var Company_State = document.getElementById('Company_State').value;
           $("#auto").html(data);
		   if($(data).text().trim() == "No Vendor Found. Add new") {
	...
	function load_ajax_data(div,pro,divs,desc) 
	{
		...
		var Show_Purchasetax = document.getElementById('Show_Purchasetax').value; 
		$.post('global_product_vendor_data.php', {'sa':pro,'div':divs, 'desc': desc, 'show_hsn': Show_HSN_Code, 'show_tax': Show_Purchasetax}, function(data){
           $('#'+div).html(data);
		  $('.showdata').html("");
		   binds();
		   update_total();
	...
	function load_pus_invoice(val) 
	{
		$.post('pus_invoice_search.php', {'search_term':val}, function(data){ 
		   $("#auto").html(data);
		  });
	}
