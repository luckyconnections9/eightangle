...
$meta_title = "Edit Purchase Invoice - 8angle | POS  ";
$invoice_js = "purchase";
require('header.php');
require('left.php');
		...
		<?php	
					...
					$inserted = ""; $paid_amount = 0;
						...
						if(!$pus_invoice->getID($order_id)) {
							echo '<META HTTP-EQUIV="Refresh" Content="0; URL=pus_invoice.php?updated=N">'; 
							exit();
						} 
						else
						{
					...
					if(isset($_POST['EditInvoice']) or isset($_POST['EditInvoicenew']))
						{
							...
							if($pus_invoice->update($order_id,$invoice_number_value,$invtype,$inv_user,$date,$inv_user_name,$customer_state,$inv_discount,$code,$same_as_billing_address,$address,$city,$state,$inv_comment,$invoice_reference,$due_period,$billing_address_id,$ship_to,$gst,$pin))
							{
								...
								if(!$inv_user) {
									...
									$st = getDB()->prepare("UPDATE `payable` SET `receipt_date` = :date1,`customer_id`='$inv_user', `customer_name` = :inv_user_name,`amount` = :balance,`paid_date` = :date, `invtype` = :invtype WHERE `invoice_id` = :order_id LIMIT 1");
								...
								{
									$inserted ="Invoice was Purchased edited successfully";
			...
			<form class="form-horizontal" id="formPusinvoice" method='post' action="pus_invoice_edit.php?edit_id=<?php echo $order_id;?>&code=<?php echo $code;?>">
				...
				<div class="box-body" id="lc-invoice">
						<div class="col-sm-12" style="text-align:left">
								...
								<p>
									...
									<a href="<?php echo BASE_URL;?>payable_add.php?inv_id=<?php echo $order_id;?>"  class="btn btn-primary pull-right">Create Credit/Debit Receipt</a>
								</p>
								<p></p>
						</div>
						<div class="col-sm-12">
					...
					<div class="box-footer">
						...
						<a href="printpurchaseinvoice.php?print_id=<?php print($order_id); ?>" target="_blank" class="btn btn-info pull-right">Print</a>
