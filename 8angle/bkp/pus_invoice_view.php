...
$meta_title = "View Purchase Invoice";
  ...
  <section class="invoice">
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">
			...
			<small class="pull-right">Date: <?php echo displaydateformat("d/m/Y",substr($date,0,10));?><br/> Purchase Invoice
			</small>
			<small>
	...
	<div class="row">
		<div class="col-xs-3">
			...
			<?php if($invtype == "Reverse") { echo $invtype. " <b>invoice</b>"; } ?>
		</div>
		<div class="col-xs-3"> 
