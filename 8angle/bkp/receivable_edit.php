...
$meta_title = "Edit Credit/Debit Receipt  - 8angle | POS  ";
$invoice_js = "sale";
require('header.php');
require('left.php');
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Edit Credit/Debit Receipt 
		   <small></small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo BASE_URL;?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
			<li><a href="<?php echo BASE_URL;?>receipts.php">Credit/Debit Receipt </a></li>
			<li class="active">Edit Credit/Debit Receipt </li>
		</ol>
    </section>
		...
		<?php	
					...
					$paid_amount = 0;
						...
						if(!$invoice->getID($order_id)) {
							echo '<META HTTP-EQUIV="Refresh" Content="0; URL=receipts.php?updated=N">'; 
							exit();
						} 
						else
						{
			...
			<input type="hidden" id="Show_Saletax" value="<?php echo $show_tax; ?>" >
			<form class="form-horizontal" id="formInvoice" method='post' action="receivable_edit.php?edit_id=<?php echo $order_id;?>&code=<?php echo $code;?>">
			...
			<center>
				<div class="box-body" id="lc-invoice">
					...
					<div class="box-footer">
						...
						<a href="printcdssalereceipt.php?print_id=<?php print($order_id); ?>" target="_blank" class="btn btn-info pull-right">Print</a>
