...
$meta_title = "Manage Vendors - 8angle | POS  ";
require('header.php');
require('left.php');
	...
	<section class="content">
		...
		<div class="box">
			<div class="box-header">
				...
				<a href="vendors_add.php" class="btn btn-large btn-info col-sm-2"><i class="glyphicon glyphicon-plus"></i>Add Vendor</a>
			</div>
			<div class="box-body">
				<div class="col-sm-12">
					<?php
					...
					<thead>					
					 ...
					 <tbody>
						...
						$query = "SELECT *,(SELECT Name 
							FROM city
							WHERE customers.city = city.ID)city FROM `customers` where $searchquery  `company_id` = :company_id  AND `deleted` = 'N' AND `customer_type` = 'Vendor' ORDER BY $sortby $sortorder";      
						$params[':company_id'] = $company_id;	
							
						$records_per_page=20;
						$newquery = $pagination->paging($query,$records_per_page);
						$vendors->dataview($newquery,$params);
						?>
						<tr>
