...
$meta_title = "Add Expense Category - 8angle | POS  ";
require('header.php');
require('left.php');
...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo BASE_URL;?>expensescategory.php">Expense Categories</a></li>
			...
			if(isset($_POST['AddCategory']))
				{
					...
					if($expensescategory->create($name,$description,$status,$parent))
					{
						$inserted ="Expense Category was added successfully";
						$name= "";
						$parent= 0;
						$description= "";
						$status= "";
					...
					{
						$failure = "Error while adding Expense Category!";
					}
				}
				?>
				<?php
				...
				<form class="form-horizontal" id="formCategory"  method='post' action="">
						<div class="form-group">
							<label for="name" class="col-sm-2 control-label">Expense Category Name</label>
							<div class="col-sm-4">
					...
					<div class="box-footer">
						<a href="<?php echo BASE_URL;?>expensescategory.php" class="btn btn-default">Cancel</a>
						<button type="submit" name="AddCategory" class="btn btn-info pull-right" value="Add">Add Expense Category</button>
					</div>
					<!-- /.box-footer -->
				</form>
			</div>
