		...
		<div class="register-box">
			...
			<div class="register-box-body">
				...
				<form action="" method="post" id="formRegister">
					<input type="hidden"  value="<?php echo $product_type;?>" class="form-control input-lg" name="producttypeReg" autocomplete="off" placeholder="" >
					<div class="row" >
						<div class="col-xs-6">
							<!-- Company Details -->
							...
							<div class="form-group has-feedback">
								<input type="text" name="gstinReg" autocomplete="off" class="form-control input-lg" placeholder="GSTIN" >
							</div>
							<div class="form-group has-feedback">
							...
							<div class="form-group has-feedback">
								<input type="text" name="emailReg" autocomplete="off" class="form-control input-lg" placeholder="Email" required>
							</div>
							<div class="form-group has-feedback">
								<input type="text" name="referenceReg" autocomplete="off" class="form-control input-lg" placeholder="Reference" >
							</div>
						</div>
						<div class="col-xs-6" >
							<div class="form-group has-feedback">
						...
						$.ajax({
											...
											success: function(data) {
												if(data.type == 'success') {
													$("#errordata").html('Registered successfully. redirecting to create user....');
